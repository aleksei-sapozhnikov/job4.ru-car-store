...
import carstore.model.annotations.Car;
 ...
 * @since 0.1
 */
public class AnnotationsCarStore implements AutoCloseable {
    /**
     * Logger.
     */
    @SuppressWarnings("unused")
    private static final Logger LOG = LogManager.getLogger(AnnotationsCarStore.class);
